...
// Server · Logs · Updates · About); app-own sections (General leading, the voice
// lane trailing) sit around them. The view renders SETTINGS_SECTION_IDS directly,
// so this asserts exactly what the user sees. Manifest imported by relative path
// on purpose — the kit barrel would drag styles.css into the test environment.
