...
JV_MODEL_CATALOG: list[dict] = [
    ...
    {"id": "gemma-4-e4b-qat", "name": "Gemma 4 E4B (QAT)",
     ...
     "mtp": False, "sliding_window": 512, "kv_global_bytes_per_token": 14336.0, "kv_windowed_bytes_per_token": 35840.0, "embedding_length": 2560, "head_count": 8, "n_kv_heads": 2, "block_count": 42, "mtp_draft_quant": "Q4_K_S", "mtp_draft_file": "gemma-4-E4B-it-assistant.Q4_K_S.gguf",
