...
JV_MODEL_CATALOG: list[dict] = [
    ...
    {"id": "gemma-4-12b-qat", "name": "Gemma 4 12B (QAT)",
     ...
     "tier": "mid", "license": "Apache-2.0", "position": 21,
    ...
    {"id": "gemma-4-e4b-qat", "name": "Gemma 4 E4B (QAT)",
     ...
     "mtp": False, "output_bytes": 377497600, "layers_nonexp_bytes": 2221443392, "sliding_window": 512, "kv_global_bytes_per_token": 14336.0, "kv_windowed_bytes_per_token": 35840.0, "embedding_length": 2560, "head_count": 8, "n_kv_heads": 2, "block_count": 42, "mtp_draft_quant": "Q4_K_S", "mtp_draft_file": "gemma-4-E4B-it-assistant.Q4_K_S.gguf",
     "mtp_draft_repo": "AtomicChat/gemma-4-E4B-it-assistant-GGUF",
     "est_vram_mb": 5211, "size_bytes": 4215695776, "size_label": "7.5B", "trained_ctx": 131072,
     "samplers": {"top_k": "64", "top_p": "0.95", "temperature": "1"},
     "tier": "mid", "license": "Apache-2.0", "position": 22,
