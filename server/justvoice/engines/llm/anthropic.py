...
runtime dependency on the `anthropic` pip package. JustVoice ships as
a PyInstaller-bundled desktop app — fewer optional deps means smaller
build + fewer install hiccups.
"""
