...
Also exposes an OpenAI-compat shim at /v1beta/openai if the user prefers;
this adapter targets the native shape because that's what new features
(thinking budget, code execution tools) surface on first.
"""
